/*
  This file is (was originally) part of MADNESS.
...
complexd conhyp(const complexd& a_arg,
    ...
    for (int attempts=0; attempts<3; attempts++) {
        ...
        // Norm of previous term for convergence test
        extended_real absprevterm = 999.0;

        // Size of largest intermediate for precision check
        extended_real maxsum = 0.0;
